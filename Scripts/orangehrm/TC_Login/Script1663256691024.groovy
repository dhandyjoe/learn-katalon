...
WebUI.click(findTestObject('Object Repository/ORANGE/Page_OrangeHRM/i_PIM_oxd-icon bi-caret-down-fill oxd-userd_9ba5b3'))

WebUI.click(findTestObject('Object Repository/ORANGE/Page_OrangeHRM/a_Logout'))
